...
import 'package:anilist_data_viz/charts/syncfusion/syncfusion_bar_charts.dart';
...
class SyncfusionChartsGalleryScreen extends StatefulWidget {
  const SyncfusionChartsGalleryScreen({super.key});

  @override
  State<SyncfusionChartsGalleryScreen> createState() => _SyncfusionChartsGalleryScreenState();
}

class _SyncfusionChartsGalleryScreenState extends State<SyncfusionChartsGalleryScreen> {
  @override
  void initState() {
    super.initState();
...
List<_CaseSpec> _buildCases(BuildContext context, _GalleryData d) {
  ...
  return [
    _CaseSpec(
      number: 1, name: 'Barra Vertical Ordinal Estándar', family: 'Cartesian (Bar/Column)', classification: n,
      dataUsed: '$_t1 · top 10',
      chart: SyncfusionBasicBarChart(data: d.genreTop10, showBorder: true),
    ),
    _CaseSpec(
      number: 2, name: 'Barra Horizontal Ordinal', family: 'Cartesian (Bar/Column)', classification: v,
      dataUsed: '$_t1 · top 10 · rotationQuarterTurns: 1',
      height: 320,
      chart: SyncfusionBasicBarChart(data: d.genreTop10, isHorizontal: true, showBorder: true),
    ),
    _CaseSpec(
      number: 3, name: 'Barra Numérica (Eje X Continuo)', family: 'Cartesian (Bar/Column)', classification: v,
      ...
      chart: SyncfusionBasicBarChart(data: d.lengthBins, showBorder: true, showGrid: true, barWidth: 22),
    ),
    _CaseSpec(
      number: 4, name: 'Barra Temporal Simple', family: 'Cartesian (Bar/Column)', classification: v,
      dataUsed: _n1,
      chart: SyncfusionBasicBarChart(
        data: d.countPerYearCategories, barWidth: 6, categoryLabelEvery: 5, showBorder: true, showGrid: true,
      ),
    ),
    _CaseSpec(
      number: 5, name: 'Barra Personalizada Ligera (Custom Bar)', family: 'Cartesian (Bar/Column)', classification: v,
    ...
    _CaseSpec(
      number: 6, name: 'Barras con Color Estático Único', family: 'Cartesian (Bar/Column)', classification: v,
      dataUsed: '$_t1 · top 10 · un solo color',
      chart: SyncfusionBasicBarChart(data: d.genreTop10, staticColor: ChartPalette.categorical[1], showBorder: true),
    ),
    _CaseSpec(
      number: 7, name: 'Barras con Color por Categoría', family: 'Cartesian (Bar/Column)', classification: v,
      dataUsed: '$_t1 · top 10 · un color de la paleta por categoría',
      chart: SyncfusionBasicBarChart(data: d.genreTop10, colorMode: BarColorMode.byCategory, showBorder: true),
    ),
    _CaseSpec(
      number: 8, name: 'Barras con Esquinas Redondeadas', family: 'Cartesian (Bar/Column)', classification: v,
      dataUsed: '$_t1 · top 10 · borderRadius superior 8',
      chart: SyncfusionBasicBarChart(data: d.genreTop10, barWidth: 22, rounded: true, cornerRadius: 8, showBorder: true),
    ),
    _CaseSpec(
      number: 9, name: 'Barras sin Ejes (Estilo Sparkline)', family: 'Cartesian (Bar/Column)', classification: v,
    ...
    _CaseSpec(
      number: 10, name: 'Barras con Línea Base Cero Fija', family: 'Cartesian (Bar/Column)', classification: v,
    ...
    _CaseSpec(
      number: 11, name: 'Barras con Valores Negativos', family: 'Cartesian (Bar/Column)', classification: v,
      ...
      chart: SyncfusionBasicBarChart(
        ...
        showGrid: true,
        yLabelFormatter: _signed,
      ),
    ),
    _CaseSpec(
      number: 12, name: 'Línea Numérica Simple', family: 'Cartesian (Line)', classification: n,
      dataUsed: 'N2 mediaToNumericBins: obras por averageScore en bins de 5 (x = inicio del bin)',
      chart: SyncfusionBasicLineChart(points: d.scoreBins5, xLabelInterval: 5),
    ),
    _CaseSpec(
      number: 13, name: 'Línea Temporal Básica', family: 'Cartesian (Line)', classification: v,
      dataUsed: _t2,
      chart: SyncfusionBasicLineChart(points: d.scorePerYear, xLabelInterval: 5),
    ),
    _CaseSpec(
      number: 14, name: 'Línea con Puntos Marcadores', family: 'Cartesian (Line)', classification: v,
      dataUsed: '$_t2 · FlDotData',
      chart: SyncfusionBasicLineChart(points: d.scorePerYear, xLabelInterval: 5, showDots: true),
    ),
    _CaseSpec(
      number: 15, name: 'Área Bajo la Curva Simple', family: 'Cartesian (Line)', classification: v,
      dataUsed: '$_t2 · belowBarData',
      chart: SyncfusionBasicLineChart(points: d.scorePerYear, xLabelInterval: 5, showArea: true),
    ),
    _CaseSpec(
      number: 16, name: 'Línea sin Puntos ni Relleno (Minimalista)', family: 'Cartesian (Line)', classification: v,
      dataUsed: '$_t2 · sin puntos, área, ejes, cuadrícula ni borde',
      chart: SyncfusionBasicLineChart(
        points: d.scorePerYear, showTitles: false, showGrid: false, showBorder: false,
      ),
    ),
    _CaseSpec(
      number: 17, name: 'Torta / Pie Estándar Ordinal', family: 'Circular (Pie/Doughnut)', classification: n,
      dataUsed: 'N4 mediaToCategoryCount(${d.pieMain.field}) · cada obra cuenta una vez',
      chart: SyncfusionBasicPieChart(data: d.pieMain.data),
    ),
    _CaseSpec(
      number: 18, name: 'Torta con Datos Numéricos', family: 'Circular (Pie/Doughnut)', classification: v,
      dataUsed: 'N2 mediaToNumericBins: averageScore en bins de 10 (obras sin score excluidas)',
      chart: SyncfusionBasicPieChart(data: d.scoreBins10),
    ),
    _CaseSpec(
      number: 19, name: 'Dona / Donut Chart Clásica', family: 'Circular (Pie/Doughnut)', classification: v,
      dataUsed: 'N4 mediaToCategoryCount(${d.pieAlt.field}) · centerSpaceRadius',
      chart: SyncfusionBasicPieChart(data: d.pieAlt.data, isDonut: true),
    ),
    _CaseSpec(
      number: 20, name: 'Dona con Anillo Delgado', family: 'Circular (Pie/Doughnut)', classification: v,
      dataUsed: 'N4 mediaToCategoryCount(${d.pieMain.field}) · centerSpaceRadius grande + radius pequeño',
      chart: SyncfusionBasicPieChart(data: d.pieMain.data, isThinDonut: true),
    ),
    _CaseSpec(
      number: 21, name: 'Gráfica de Torta Monocromática (Gama de Tonos)', family: 'Circular (Pie/Doughnut)', classification: v,
      dataUsed: 'N4 mediaToCategoryCount(${d.pieAlt.field}) · tonos HSL de un solo color',
      chart: SyncfusionBasicPieChart(data: d.pieAlt.data, monochromatic: true, baseColor: ChartPalette.categorical[6]),
    ),
    _CaseSpec(
    ...
    _CaseSpec(
      number: 23, name: 'Barras con Espaciado Entre Elementos', family: 'Cartesian (Bar/Column)', classification: v,
      dataUsed: '$_t1 · top 6 · width 16 + groupsSpace 36 (alignment center)',
      chart: SyncfusionBasicBarChart(data: d.genreTop6, barWidth: 16, groupsSpace: 36, showBorder: true),
    ),
    _CaseSpec(
      number: 24, name: 'Barras con Líneas de Cuadrícula Activas', family: 'Cartesian (Bar/Column)', classification: v,
      dataUsed: '$_t1 · top 10 · FlGridData horizontal',
      chart: SyncfusionBasicBarChart(data: d.genreTop10, showGrid: true, showBorder: true),
    ),
    _CaseSpec(
      number: 25, name: 'Barras con Animación Desactivada', family: 'Cartesian (Bar/Column)', classification: v,
      dataUsed: '$_t1 · top 10 · duration: Duration.zero',
      chart: SyncfusionBasicBarChart(data: d.genreTop10,  showBorder: true),
    ),
    _CaseSpec(
      number: 26, name: 'Línea con Animación Desactivada', family: 'Cartesian (Line)', classification: v,
      dataUsed: '$_t2 · duration: Duration.zero',
      chart: SyncfusionBasicLineChart(points: d.scorePerYear, xLabelInterval: 5, animated: false),
    ),
    _CaseSpec(
      number: 27, name: 'Torta sin Animación', family: 'Circular (Pie/Doughnut)', classification: v,
      dataUsed: 'N4 mediaToCategoryCount(${d.pieMain.field}) · duration: Duration.zero',
      chart: SyncfusionBasicPieChart(data: d.pieMain.data, animated: false),
    ),
    _CaseSpec(
      number: 28, name: 'Barra de Progreso Simple (KPI Lineal)', family: 'Cartesian (Bar/Column)', classification: v,
      ...
      chart: summary.finishedPercent == null
          ...
          : SyncfusionProgressBarChart(value: summary.finishedPercent!, color: ChartPalette.positive),
    ),
    _CaseSpec(
      number: 29, name: 'Torta con Borde de Separación entre Porciones', family: 'Circular (Pie/Doughnut)', classification: v,
      dataUsed: 'N4 mediaToCategoryCount(${d.pieAlt.field}) · sectionsSpace 3 + borderSide',
      chart: Builder(
        builder: (context) => SyncfusionBasicPieChart(
          data: d.pieAlt.data,
          spacing: 3,
    ...
    _CaseSpec(
      number: 30, name: 'Comparativa Binaria (Doble Barra Simple)', family: 'Cartesian (Bar/Column)', classification: v,
      ...
      chart: SyncfusionBasicBarChart(
        data: d.binary.data, barWidth: 48, colorMode: BarColorMode.byCategory, showRodLabels: true, showBorder: true,
      ),
    ),
    _CaseSpec(
      number: 31, name: 'Gráfica para Tarjeta de Resumen (Compact Card)', family: 'LineChart + Flutter', classification: c,
      dataUsed: 'N7 (total y score medio) + N1 como sparkline (SyncfusionBasicLineChart minimalista)',
      height: 240,
      chart: Align(
        alignment: Alignment.centerLeft,
        child: SizedBox(
          width: 320,
          child: SyncfusionCompactSummaryCard(
    ...
    _CaseSpec(
      number: 32, name: 'Barras Agrupadas Multiserie', family: 'Cartesian (Bar/Column)', classification: v,
      dataUsed: 'N5 mediaToSeriesByCategory (status vs source)',
      chart: SyncfusionMultiSeriesBarChart(seriesList: d.seriesByCategory, barWidth: 8),
    ),
    _CaseSpec(
      number: 33, name: 'Barras Apiladas', family: 'Cartesian (Bar/Column)', classification: v,
      dataUsed: 'N5 mediaToSeriesByCategory (status vs source) · isStacked',
      chart: SyncfusionMultiSeriesBarChart(seriesList: d.seriesByCategory, isStacked: true, barWidth: 20),
    ),
    _CaseSpec(
      number: 34, name: 'Líneas Multiserie Comparativas', family: 'Cartesian (Line)', classification: v,
      dataUsed: 'N10 mediaToSeriesPerYear (source)',
      chart: SyncfusionMultiLineChart(seriesList: d.seriesPerYear, showGrid: true),
    ),
    _CaseSpec(
      number: 35, name: 'Línea con Relleno Semitransparente Personalizado', family: 'Cartesian (Line)', classification: v,
      dataUsed: '$_t2 · showArea con color personalizado',
      chart: SyncfusionBasicLineChart(points: d.scorePerYear, xLabelInterval: 5, showArea: true, lineColor: Colors.deepPurpleAccent),
    ),
    _CaseSpec(
      ...
      chart: Stack(
        ...
        children: [
          SyncfusionBasicPieChart(data: d.pieMain.data, isDonut: true, showTitles: false),
          Column(
            mainAxisSize: MainAxisSize.min,
            children: [
    ...
    _CaseSpec(
      number: 37, name: 'Donut con Etiquetas de Porcentaje Externas', family: 'Circular (Pie/Doughnut)', classification: v,
      dataUsed: 'N4 mediaToCategoryCount · titlePositionPercentageOffset: 1.5',
      chart: SyncfusionBasicPieChart(data: d.pieMain.data, isDonut: true, titlePositionPercentageOffset: 1.5, minPercentForTitle: 0),
    ),
    _CaseSpec(
      number: 38, name: 'Donut con Etiquetas de Porcentaje Internas', family: 'Circular (Pie/Doughnut)', classification: v,
      dataUsed: 'N4 mediaToCategoryCount · titlePositionPercentageOffset: 0.5',
      chart: SyncfusionBasicPieChart(data: d.pieMain.data, isDonut: true, titlePositionPercentageOffset: 0.5, minPercentForTitle: 0),
    ),
    _CaseSpec(
      number: 39, name: 'Serie Temporal Multivariable', family: 'Cartesian (Line)', classification: v,
      dataUsed: 'N9 mediaToYearMetricsNormalized (conteo vs score normalizados a 0-1)',
      chart: SyncfusionMultiLineChart(seriesList: d.yearMetricsNormalized, isCurved: true),
    ),
    _CaseSpec(
      number: 40, name: 'Gráfica de Barras con Etiquetas Numéricas Superiores', family: 'Cartesian (Bar/Column)', classification: v,
      dataUsed: '$_t1 · top 8 · showRodLabels',
      chart: SyncfusionBasicBarChart(data: d.genreTop8, showRodLabels: true, maxY: d.genreTop8.isEmpty ? null : d.genreTop8.first.value * 1.2),
    ),
    _CaseSpec(
      number: 41, name: 'Gráfica de Líneas con Ejes Rotados', family: 'Cartesian (Line)', classification: c,
      dataUsed: '$_t2 · RotatedBox(quarterTurns: 1)',
      height: 360,
      chart: RotatedBox(
        quarterTurns: 1,
        child: SyncfusionBasicLineChart(points: d.scorePerYear, xLabelInterval: 5),
      ),
    ),
    _CaseSpec(
      number: 42, name: 'Barras con Línea de Meta o Target Line', family: 'Cartesian (Bar/Column)', classification: v,
    ...
    _CaseSpec(
      number: 43, name: 'Barras con Desplazamiento Horizontal', family: 'Cartesian (Bar/Column)', classification: c,
      ...
      chart: SingleChildScrollView(
        ...
        child: SizedBox(
          ...
          child: SyncfusionBasicBarChart(data: d.allGenres, barWidth: 16),
        ),
      ),
    ),
    _CaseSpec(
      ...
      chart: StreamBuilder<List<ChartDataXY>>(
        ...
        builder: (context, snapshot) {
          ...
          return SyncfusionBasicLineChart(points: data, animated: false);
        },
      ),
    ),
    _CaseSpec(
        ...
        children: [
          ClipRect(
            child: Align(
              ...
              heightFactor: 0.5,
              child: SyncfusionBasicPieChart(data: d.pieMain.data.take(3).toList(), isDonut: true, showTitles: false),
            ),
          ),
    ...
    _CaseSpec(
      number: 46, name: 'Gráfica de Líneas con Selección de Punto', family: 'Cartesian (Line)', classification: n,
      dataUsed: '$_t2 · Touch Interaction (enableTouch: true)',
      chart: SyncfusionBasicLineChart(points: d.scorePerYear, xLabelInterval: 5, enableTouch: true, showDots: true),
    ),
    _CaseSpec(
      number: 47, name: 'Barras con Rango de Eje Y Forzado', family: 'Cartesian (Bar/Column)', classification: v,
      dataUsed: '$_t1 · top 10 · minY: 0, maxY: 100',
      chart: SyncfusionBasicBarChart(data: d.genreTop10, minY: 0, maxY: 100),
    ),
    _CaseSpec(
      number: 48, name: 'Barras Horizontales con Agrupamiento Multiserie', family: 'Cartesian (Bar/Column)', classification: v,
      dataUsed: 'N5 mediaToSeriesByCategory · isHorizontal',
      height: 400,
      chart: SyncfusionMultiSeriesBarChart(seriesList: d.seriesByCategory, isHorizontal: true, barWidth: 8),
    ),
    _CaseSpec(
      number: 49, name: 'Gráfica con Formato Monetario en Eje Y', family: 'Cartesian (Bar/Column)', classification: v,
      dataUsed: '$_t1 · valueFormatter con \$ (simulación)',
      chart: SyncfusionBasicBarChart(data: d.genreTop10, yLabelFormatter: (v) => '\$${v.toInt()}'),
    ),
    _CaseSpec(
      number: 50, name: 'Gráfica con Formato de Fecha Personalizado en Eje X', family: 'Cartesian (Line)', classification: v,
    ...
    _CaseSpec(
      number: 51, name: 'Barras con Gradiente Vertical Manual', family: 'Cartesian (Bar/Column)', classification: v,
    ...
    _CaseSpec(
      ...
      chart: Column(
        children: [
          ...
          Expanded(child: SyncfusionBasicBarChart(data: d.genreTop10.where((e) => e.value > 10).toList())),
        ],
      ),
    ),
    _CaseSpec(
      number: 53, name: 'Gráfica de Líneas con Curvas Suavizadas', family: 'Cartesian (Line)', classification: v,
      dataUsed: '$_t2 · isCurved: true',
      chart: SyncfusionBasicLineChart(points: d.scorePerYear, isCurved: true, xLabelInterval: 5),
    ),
    _CaseSpec(
      number: 54, name: 'Dona con Porción Resaltada', family: 'Circular (Pie/Doughnut)', classification: v,
      dataUsed: 'N4 mediaToCategoryCount · highlightedIndex = 0',
      chart: SyncfusionBasicPieChart(data: d.pieMain.data, isDonut: true, highlightedIndex: 0),
    ),
    _CaseSpec(
      number: 55, name: 'Gráfica de Distribución de Frecuencias (Histograma)', family: 'Cartesian (Bar/Column)', classification: v,
      dataUsed: 'N2 numericBins · groupsSpace: 0',
      chart: SyncfusionBasicBarChart(data: d.scoreBins10, groupsSpace: 0, showBorder: true),
    ),
    _CaseSpec(
      ...
      chart: SyncfusionScatterTrendChart(
    ...
    _CaseSpec(
      ...
      dataUsed: 'N7 summaryKpis + SyncfusionBasicLineChart',
      chart: SyncfusionCompactSummaryCard(
        title: 'Dashboard KPI',
        value: summary.finishedCount.toString(),
        caption: 'Obras finalizadas',
        chart: SyncfusionBasicLineChart(points: d.countPerYear, showTitles: false, showGrid: false, showBorder: false, showArea: true, enableTouch: false),
      ),
    ),
    _CaseSpec(
      ...
      chart: RepaintBoundary(
        child: Container(
          ...
          child: SyncfusionBasicBarChart(data: d.genreTop6),
        ),
      ),
    ),
    _CaseSpec(
      ...
      chart: Stack(
        alignment: Alignment.center,
        children: [
          SyncfusionBasicPieChart(data: d.pieMain.data, isDonut: true, isThinDonut: true, showTitles: false),
          Padding(
            padding: const EdgeInsets.all(40),
            child: SyncfusionBasicPieChart(data: d.pieAlt.data, isDonut: true, isThinDonut: true, showTitles: false),
          ),
        ],
      ),
    ),
    _CaseSpec(
      number: 60, name: 'Barras con Líneas de Cuadrícula Secundarias', family: 'Cartesian (Bar/Column)', classification: v,
      dataUsed: '$_t1 · gridInterval reducido',
      chart: SyncfusionBasicBarChart(data: d.genreTop10, showGrid: true, gridInterval: 5),
    ),
    _CaseSpec(
      number: 61, name: 'Gráfica de Progreso Multinivel', family: 'Cartesian (Bar/Column)', classification: v,
      dataUsed: 'N7 · SyncfusionMultiSeriesBarChart con isStacked y horizontal',
      height: 100,
      chart: SyncfusionMultiSeriesBarChart(
        seriesList: [
    ...
    _CaseSpec(
      number: 62, name: 'Gráfica con Fondo de Área Condicional', family: 'Cartesian (Line)', classification: v,
      dataUsed: '$_t2 · belowBarData',
      chart: SyncfusionBasicLineChart(points: d.scorePerYear, xLabelInterval: 5, showArea: true, minY: 50),
    ),
    _CaseSpec(
      ...
      chart: Column(
        children: [
          Expanded(child: SyncfusionBasicLineChart(points: d.scorePerYear, xLabelInterval: 5)),
          const SizedBox(height: 16),
          Expanded(child: SyncfusionBasicBarChart(data: d.countPerYearCategories, categoryLabelEvery: 5)),
        ],
      ),
    ),
  ];
