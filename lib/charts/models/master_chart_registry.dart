...
//
// - Clasificación: CAPACIDAD de la librería para el caso (evaluación teórica).
// - Estado: situación de la implementación en este proyecto. Los 252 casos
//   tienen gráfico (ver lib/charts/common/library_cases.dart); PARCIAL indica
//   que la representación cubre el caso solo en parte (se explica en la nota
//   de la tarjeta y en la documentación).
...
const List<MasterChartSpec> masterChartRegistry = [
  MasterChartSpec(
    ...
    support: {
      ...
      ChartLibrary.dChart: LibrarySupport(ChartClassification.nativo, ChartState.funcional),
  ...
  MasterChartSpec(
    ...
    support: {
      ChartLibrary.flChart: LibrarySupport(ChartClassification.nativo, ChartState.funcional),
      ChartLibrary.syncfusion: LibrarySupport(ChartClassification.nativo, ChartState.funcional),
      ChartLibrary.dChart: LibrarySupport(ChartClassification.variante, ChartState.funcional),
      ChartLibrary.graphic: LibrarySupport(ChartClassification.nativo, ChartState.funcional),
    },
  ),
  MasterChartSpec(
  ...
  MasterChartSpec(
    ...
    support: {
      ...
      ChartLibrary.syncfusion: LibrarySupport(ChartClassification.nativo, ChartState.funcional),
      ChartLibrary.dChart: LibrarySupport(ChartClassification.composicion, ChartState.funcional),
      ChartLibrary.graphic: LibrarySupport(ChartClassification.nativo, ChartState.funcional),
    },
  ),
  MasterChartSpec(
  ...
  MasterChartSpec(
    ...
    support: {
      ChartLibrary.flChart: LibrarySupport(ChartClassification.nativo, ChartState.funcional),
      ChartLibrary.syncfusion: LibrarySupport(ChartClassification.nativo, ChartState.funcional),
      ChartLibrary.dChart: LibrarySupport(ChartClassification.noSoportado, ChartState.funcional),
      ChartLibrary.graphic: LibrarySupport(ChartClassification.nativo, ChartState.funcional),
    },
  ),
  MasterChartSpec(
  ...
  MasterChartSpec(
    ...
    support: {
      ChartLibrary.flChart: LibrarySupport(ChartClassification.nativo, ChartState.funcional),
      ChartLibrary.syncfusion: LibrarySupport(ChartClassification.nativo, ChartState.funcional),
      ChartLibrary.dChart: LibrarySupport(ChartClassification.variante, ChartState.parcial),
      ChartLibrary.graphic: LibrarySupport(ChartClassification.nativo, ChartState.funcional),
    },
  ),
  MasterChartSpec(
  ...
  MasterChartSpec(
    ...
    support: {
      ChartLibrary.flChart: LibrarySupport(ChartClassification.composicion, ChartState.funcional),
      ChartLibrary.syncfusion: LibrarySupport(ChartClassification.composicion, ChartState.funcional),
      ChartLibrary.dChart: LibrarySupport(ChartClassification.composicion, ChartState.funcional),
      ChartLibrary.graphic: LibrarySupport(ChartClassification.composicion, ChartState.funcional),
    },
  ),
